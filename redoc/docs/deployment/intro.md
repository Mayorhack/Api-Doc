...
- **[Live demo](https://redocly.github.io/redoc/):**
  ...
  A version of the Swagger Rex MFBank API is displayed by default. To test it with your own OpenAPI definition, enter the URL for your
...
- OpenAPI 3.0
  ...
  - [Swagger Rex MFBank Sample OpenAPI Definition](https://Rex MFBank3.swagger.io/api/v3/openapi.json)
- OpenAPI 2.0
